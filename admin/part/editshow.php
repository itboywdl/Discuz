...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
	...
	<?php
	//准备sql语句
	$sql="select id,pname from part where id='{$s}'";
	...
	?>
		<!--给一个隐藏域-->
	<input type="hidden" name="pid" value="<?php echo $uifo['id'];?>">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户名：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="pname" value="<?php echo $uifo['pname'];  ?>" class="text-word">
        </td>
        </tr>
		<?php
			}
