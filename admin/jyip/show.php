  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">禁用的IP</th>
        <th align="center" valign="middle" class="borderright">禁用的IP开关</th>
        <th align="center" valign="middle">操作</th>
      </tr>
	    <?php
	  //准备sql语句
	  $sql="select id,bip,kg from jip";
	  //执行sql语句
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $uifo['bip']; ?></td>
