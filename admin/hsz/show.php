...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	  ...
	  <?php
	  //准备sql语句
	  $postsql="select id,title,pip,content,ptime from hsz";
	  //执行sql语句
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="edit.php?hid=<?php echo $uifo['id']; ?>" target="mainFrame" onFocus="this.blur()" class="add">还原</a><span class="gray">&nbsp;|&nbsp;</span><a href="del.php?hid=<?php echo $uifo['id']; ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
	  <?php	  
	 	  }
	  } 
