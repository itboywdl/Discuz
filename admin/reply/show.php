...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：回帖管理</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        <th align="center" valign="middle" class="borderright">回帖编号</th>
        <th align="center" valign="middle" class="borderright">回复贴的内容</th>
        <th align="center" valign="middle" class="borderright">回帖的时间</th>
	  ...
	  <?php
	  //准备sql语句
	  $replysql="select id,content,ptime from reply";
	  //执行sql语句
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="edit.php?hid=<?php echo$uifo['id']; ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="del.php?hid=<?php echo $uifo['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
	  <?php
	  	  }
	  }else{
