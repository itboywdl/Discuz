   ...
   <!--这个是第二行-->
	...
	<div class="zhongjian">	
		...
		<div class="zhongjian1">
			<div class="zhongjianleft"><b>立即注册</b>
			</div>
		...
		<div class="zhongjian2">
			<form action="./homephp/dozhuce.php" method="post">
					<!--中间的第二部分用户名-->
					<div class="zhongjian21"><p><sup style="color:red">*</sup>用户名：<input type="text" required autofocus name="username" placeholder="请您输入用户名！" autofocus >&nbsp;<span class="zhongjian22"><b>用户名不能小于3个字符</b></span></p>
					</div>
					<!--中间的第二部分密码-->
					<div class="zhongjian21"><p><sup style="color:red">*</sup>密&nbsp;码：<span><input type="password" required name="pass" placeholder="请您输入密码！" >&nbsp;<span class="zhongjian22"></span></p>
					</div>
					<!--中间的第二部分确认密码-->
					...
					<!--中间的第二部分Email-->
					<div class="zhongjian21">
					<p><sup style="color:red">*</sup>Email： <input type="text" required name="email"  placeholder="请您输入Email！">&nbsp;<span class="zhongjian22" ></span>
					</p>
					</div>
					
					<!--中间的第二部分IP-->
					
					<p><input type="hidden"  name="ip">
					</p>
					
					
					<!--这个有时间可以优化
					<div class="zhongjian21">
					<p><sup style="color:red">*</sup>权限： <select name="qx">
					<option value="1">普通用户</option>
					<option value="2">会员</option>
					</select>
					</select>&nbsp;<span class="zhongjian22" ></span>
					</p>
					</div>-->
